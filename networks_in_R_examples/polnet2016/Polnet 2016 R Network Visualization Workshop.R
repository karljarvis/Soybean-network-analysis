...
soypath = "~/GoogleDriveNAU/telecoupling/Soybean_network_analysis/"
setwd(file.path(soypath, "Networks_in_R_examples/polnet2016"))
...
#setwd("C:/polnet2016") 
setwd("~/telecoupling/Networks_in_R_examples/polnet2016")
