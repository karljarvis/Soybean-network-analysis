...
# create models of spillovers 
  ...
  # # maybe better to use linear mixed models... but not sure
  # library(nlme)
  # us.spill.lmm = nlme::lme(fixed = us.prop ~ br.prop, data = us.spill.df, random = ~ 1|t1, correlation = corExp(1, form=~1|t1))
  # summary(us.spill.lmm)
  # 
  # 
  # # Fit model of temporal autocorrelation 
  # Am1.1 = lme(fixed = A ~ barr + mort + cost, data = ibr4, 
  #             method = "ML") # 11 pars
  # temp = update(Am1.1, correlation = corExp(1, form = ~ x + y | land/road))
  # 
  # 
  # 
  # plot(us.spill.df$br.prop, us.spill.df$us.prop)
  # 
  # links.ch = links[links$receiver == "China",]
  # links.ch[links.ch$time == 1991,]
  # 